...
const FullScreenPlayer = ({ toggle, state, controls, volumeIcon }) => {
  ...
  return (
    <div className="relative h-full" onClick={controls[state?.playing ? "pause" : "play"]}>
        ...
        <div className="absolute left-[3rem] bottom-36 flex items-center gap-x-5 ">
            <img src={current.image} alt="" className="w-24 h-24 object-cover rounded-[0.2rem] " />
      ...
      <div onClick={e=> {
        ...
        <div className="flex items-center gap-x-5">
          ...
          <button
            ...
            className="w-16 h-16 bg-white text-black rounded-full hover:scale-[1.06] flex items-center justify-center"
          >
